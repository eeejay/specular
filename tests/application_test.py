...
class ApplicationTest(TestCommon, unittest.TestCase):
    '''WAI-ARIA Application test (Windows only)
    Tests to see if the correct role is exposed via MSAA when the BODY tag has
    a role attribute of "application". This is important for toggling virtual 
    ...
    def runTest(self):
        ...
        match = sel.get_accessible_match(
            ...
            'name="ARIA Spreadsheet and Menubar" />')
        self.assertNotEqual(
